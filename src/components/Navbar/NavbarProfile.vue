...
<template>
  <div>
    <div class="flex items-center">
      <button
        class="p-1 text-gray-400 rounded-full hover:text-gray-500 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out"
      >
        <svg
          class="h-6 w-6"
...
<style lang="postcss">
.auth-button {
  @apply font-semibold px-4 py-2 rounded duration-200;
}
.login {
  @apply text-blue-500;
  &:hover {
